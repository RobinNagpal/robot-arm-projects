...
Two kinds of pixel matter. Coloured ones are the parts: the table top is
painted in a saturated colour and nothing else in the room is. Grey ones are
everything else — the floor, the holders, anything in the way — and are

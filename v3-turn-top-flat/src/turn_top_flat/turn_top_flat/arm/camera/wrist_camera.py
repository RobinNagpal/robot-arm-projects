...
Set ``TURN_TOP_FLAT_VIEWS`` to a folder and every frame taken is also saved
...
class WristCamera:
    def __init__(
        ...
        *,
        ...
        self._save_to = (
            Path(os.environ["TURN_TOP_FLAT_VIEWS"]) if os.environ.get("TURN_TOP_FLAT_VIEWS") else None
        )
        self._saved = 0
